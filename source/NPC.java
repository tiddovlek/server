public class NPC {
	...
	public int gfxId, gfxHeight = 65536;
	public boolean gfxUpdate = false;
	/**
	 * Requests a gfx, created and found by momosherilly.
	 * @param j The gfx id th NPC should call for.
	 * @param k The height of the GFX in pixels, 0 = ground, 1 = high up or medium..
	 */
	public void callGfx(int j, int k)
	{
		gfxId = j;
		if(k >= 100) gfxHeight = (6553500)+k;
		else gfxHeight = 65536;
		gfxUpdate = true;
		updateRequired = true;
	}
	/**
	 * Found by momosherilly...
	 */
	public void gfxUpdate(stream str) {
		//by momosherilly
