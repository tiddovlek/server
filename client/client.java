...
*/
    ...
    public final void method13(int i, byte byte0, String s)
    {
        ...
        char c1 = '\310';
        byte byte1 = 20;
        aClass30_Sub2_Sub1_Sub4_1272.method381(0xffffff, "Eclipse-PvP is loading - please wait...", 23693, c1 / 2 - 26 - byte1, c / 2);
        int j = c1 / 2 - 18 - byte1;
        // Colours
...
//clicking areas
    ...
    public final void method6()
    {
	    ...
	    System.out.println("Welcome to a Blank Client by Stupit!");
...
aClass30_Sub2_Sub1_Sub1Array1095[j4] = new Class30_Sub2_Sub1_Sub1(class44_2, "headicons_prayer", j4);
    ...
    public final void method94(int i)
    {
        ...
        if(aBoolean926)
        {
            ...
            int k = 35;
            g.drawString("Sorry, an error has occured whilst loading Eclipse-PvP", 30, k);
            k += 50;
        ...
        if(aBoolean1252)
        {
            ...
            g.setColor(Color.yellow);
            int l = 35;
            g.drawString("Error a copy of Eclipse-PvP already appears to be loaded", 30, l);
            l += 50;
            g.setColor(Color.white);
...
//						Class30_Sub2_Sub1_Sub4_1271.method382(0xffffff, 55, anInt939, class30_sub2_sub1_sub4.method383(anInt1116, s + ": "), 28, true);
    ...
    public final void method135(boolean flag, boolean flag1) {
        ...
        if(anInt833 == 0) {
            ...
            i = c1 / 2 - 20;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffff00, c / 2, anInt939, "@yel@Welcome to Eclipse-PvP", i, true);
            i += 30;
            int l = c / 2 - 80;
            int k1 = c1 / 2 + 20;
        ...
        if(anInt833 == 2) {
            ...
            j += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method389(false, true, c / 2 - 90, 0xfff00, "@whi@Server IP: " + server + ((anInt1216 == 2) & (anInt1105 % 40 < 20) ? "@xxx@|" : ""), j);
            j += 15;
        ...
        if(anInt833 == 3) {
            ...
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "The client was modified by Stupit,", k, true);
            k += 15;
            aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "but made by Jagex.", k, true);
            k += 15;
			   aClass30_Sub2_Sub1_Sub4_1272.method382(0xffffff, c / 2, anInt939, "Leach and have Fun!", k, true);
            k += 15;
